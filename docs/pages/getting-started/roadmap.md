...
| **Theme compatibility: Luma** | Ship a standalone Luma-compat package alongside the `magewire-hyva-theme` package so merchants on Luma can adopt Magewire without writing their own theme adapter.                                        | Low      | Not Started |

...
I can't say anything other than this: it is completely true. The investment is ridiculous, and sometimes I ask myself
...
V3 offers a lot of the same, plus innovations that grew partly from requirements such as CSP and from other ideas
...
but I expect this will go much faster now that all the tools are available. Over the coming months, the beta plan is
to work, hopefully together, toward a version that at least contains everything V1 has.
